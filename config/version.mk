...
CAFEX_MOD_VERSION := PureCAF-$(CAFEX_VERSION)-$(CAFEX_BUILD_DATE)-$(CAFEX_BUILD_TYPE)
CAFEX_FINGERPRINT := PureCAF/$(CAFEX_VERSION)/$(PLATFORM_VERSION)/$(TARGET_PRODUCT_SHORT)/$(CAFEX_BUILD_DATE)



CAFEX_DISPLAY_VERSION := PureCAF-$(CAFEX_VERSION)-$(CAFEX_BUILD_TYPE)
